			...
			if(user.email) {
				...
				docRef.get().then((doc) => {
					if (!(doc.exists)) { 
						...
						toastr.options =  {closeButton: true, debug: false, newestOnTop: true, progressBar: true, timeOut: 7500, positionClass: 'toast-top-full-width', preventDuplicates: true, onclick: null}; var $toast = toastr[shortCutFunction](msg);$toastlast = $toast;
					} else { 
						var shortCutFunction = 'success';  
						var msg = `
